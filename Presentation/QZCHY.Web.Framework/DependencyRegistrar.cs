...
namespace QZCHY.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.RegisterType<VillageService>().As<IVillageService>().InstancePerLifetimeScope();
            ...
            //builder.RegisterType<TowerService>().As<ITowerService>().InstancePerLifetimeScope();
            //builder.RegisterType<ElectricLineService>().As<IElectricLineService>().InstancePerLifetimeScope();
            //builder.RegisterType<SubStationService>().As<ISubStationService>().InstancePerLifetimeScope();
            //builder.RegisterType<TransformerService>().As<ITransformerService>().InstancePerLifetimeScope();
            //builder.RegisterType<SwitchService>().As<ISwitchService>().InstancePerLifetimeScope();
            //builder.RegisterType<MonitorService>().As<IMonitorService>().InstancePerLifetimeScope();
            //builder.RegisterType<PeopleService>().As<IPeopleService>().InstancePerLifetimeScope();
            //builder.RegisterType<DbStationService>().As<IDbStationService>().InstancePerLifetimeScope();
